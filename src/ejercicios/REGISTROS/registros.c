...
void lectura(char **** programa,int * instrucciones, int * numRegistros, int ** registros, char* nombreArchivo);
...
int main (int argc, char* argv[]){
	...
	lectura(&programa, &instrucciones,&numRegistros,&registros,nombreArchivo);
